...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function dm(s,e,t){const n=new Float32Array(ii),i=new N(0,1,0);return new mn({name:"SphericalGaussianBlur",defines:{n:ii,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:pr(),fragmentShader:`
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function wl(){return new mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:pr(),fragmentShader:`
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function Rl(){return new mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pr(),fragmentShader:`
	...
	`}class Nc extends hn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new bc(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const _g={[Ql]:"Linear",[ec]:"Reinhard",[tc]:"Cineon",[nc]:"ACESFilmic",[sc]:"AgX",[rc]:"Neutral",[ic]:"Custom"};function xg(s,e){const t=_g[e];return t===void 0?(Ee("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ys=new N;function vg(){Ge.getLuminanceCoefficients(Ys);const s=Ys.x.toFixed(4),e=Ys.y.toFixed(4),t=Ys.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const Rg={[Ks]:"SHADOWMAP_TYPE_PCF",[is]:"SHADOWMAP_TYPE_VSM"};function Cg(s){return Rg[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Ig={[oi]:"ENVMAP_TYPE_CUBE",[Ni]:"ENVMAP_TYPE_CUBE",[cr]:"ENVMAP_TYPE_CUBE_UV"};function Pg(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":Ig[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const Lg={[Ni]:"ENVMAP_MODE_REFRACTION"};function Dg(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":Lg[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Ng={[Jl]:"ENVMAP_BLENDING_MULTIPLY",[gu]:"ENVMAP_BLENDING_MIX",[_u]:"ENVMAP_BLENDING_ADD"};function Ug(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":Ng[s.combine]||"ENVMAP_BLENDING_NONE"}function Fg(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Og(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Cg(t),l=Pg(t),u=Dg(t),d=Ug(t),h=Fg(t),f=Mg(t),g=Sg(r),v=i.createProgram();let m,p,S=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(rs).join(`
`)),a=$a(a),a=Bl(a,t),a=Vl(a,t),o=$a(o),o=Bl(o,t),o=Vl(o,t),a=kl(a),o=kl(o),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`)+`
`+p);const T=S+m+a,y=S+p+o,A=Ul(i,i.VERTEX_SHADER,T),w=Ul(i,i.FRAGMENT_SHADER,y);i.attachShader(v,A),i.attachShader(v,w),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function C(R){if(s.debug.checkShaderErrors){const B=i.getProgramInfoLog(v)||"",k=i.getShaderInfoLog(A)||"",W=i.getShaderInfoLog(w)||"",V=B.trim(),z=k.trim(),U=W.trim();let Q=!0,Z=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(Q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,A,w);else{const ce=Ol(i,A,"vertex"),pe=Ol(i,w,"fragment");Re("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
